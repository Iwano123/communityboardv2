...
3. **Få åtkomst till applikationen**
   ...
   - **Admin-gränssnitt**: http://localhost:5001/admin (användarnamn: `tom`, lösenord: `Abcd1234!`)
...
1. Logga in på admin-gränssnittet: http://localhost:5001/admin (användarnamn: `tom`, lösenord: `Abcd1234!`)
